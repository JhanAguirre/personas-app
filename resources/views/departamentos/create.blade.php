    ...
    <div class="container">
        ...
        <form action="{{ route('departamentos.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('dep_nomb') is-invalid @enderror" id="dep_nomb" name="dep_nomb" value="{{ old('dep_nomb') }}" required>
                @error('dep_nomb')
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('pais_codi') is-invalid @enderror" id="pais_codi" name="pais_codi" required>
                    ...
                    @foreach ($paises as $pais)
                        <option value="{{ $pais->pais_codi }}" {{ old('pais_codi') == $pais->pais_codi ? 'selected' : '' }}>
                            {{ $pais->pais_nomb }}
                        </option>
                    @endforeach
                </select>
