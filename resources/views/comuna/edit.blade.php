    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('comunas.update', ['comuna' => $comuna->comu_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id" aria-describedby="codeHelp" name="id" 
                disabled="disabled" value="{{$comuna->comu_codi}}">
                <div id="codeHelp" class="form-text">Commune Id.</div>
            </div>
            <div class="mb-3">
            ...
            <select class="form-select" id="municipality" name="code" required>
                <option selected disbled value="">Choose one...</option>
