    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('comunas.update', ['comuna' => $comuna->comu_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="code" name="id" aria-describedby="codeHelp" value="{{ $comuna->comu_codi }}">
                <div id="codeHelp" class="form-text">Comuna code</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Commune</label>
                <input type="text" required class="form-control" id="name" name="name" placeholder="Commune name" value="{{ $comuna->comu_nomb }}">
            </div>
            <div class="mb-3">
